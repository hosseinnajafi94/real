...
class Formatter extends \yii\i18n\Formatter {
    ...
    public function asJdatetime($value) {
        ...
        return $output == null ? $this->nullDisplay : '<span dir="ltr" style="direction: ltr !important;">' . $output . '</span>';
    }
    ...
    public function asFile($value, $path) {
        ...
        $url = '@web/uploads/' . $path . '/' . $value;
        return Html::a(Yii::t('app', 'Download File'), $url, ['target' => '_blank', 'download' => true, 'data' => ['pjax' => '0']]);
    }
