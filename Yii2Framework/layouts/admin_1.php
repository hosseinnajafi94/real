                ...
                <div class="sidebar-content">
                    <div class="nav-container">
                        <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
                            ...
                            <li class="has-sub nav-item">
                                <a>
                                    <i class="fa fa-user" style="position: relative;"><i class="fa fa-search" style="position: absolute;bottom: -5px;right: -5px;font-size: 11px;color: white;text-shadow: 0 0 2px #000;"></i></i>
                                ...
                                <ul class="menu-content">
                                    <li class="has-sub">
                                        ...
                                        <ul class="menu-content">
                                            <li><a href="" class="menu-item">داشبورد</a></li>
                                            <li><a href="" class="menu-item">ویجت</a></li>
                                            <li><a href="" class="menu-item">چارت</a></li>
                                            <li><a href="" class="menu-item">شغل</a></li>
                                            <li><a href="" class="menu-item">قوانین</a></li>
                                            <li class="has-sub">
                                                <a class="menu-item">کارگزینی</a>
                                                <ul class="menu-content">
                                                    <li><a href="" class="menu-item">درخواست</a></li>
                                                    <li><a href="" class="menu-item">استخدام</a></li>
                                                    <li><a href="" class="menu-item">احکام</a></li>
                                                    <li><a href="" class="menu-item">پرونده</a></li>
                                                </ul>
                                            </li>
                                            <li class="has-sub">
                                                <a class="menu-item">حقوق و دستمزد</a>
                                                <ul class="menu-content">
                                                    <li><a href="" class="menu-item">لیست حقوق</a></li>
                                                    <li><a href="" class="menu-item">لیست معوقه</a></li>
                                                    <li><a href="" class="menu-item">عیدی</a></li>
                                                    <li><a href="" class="menu-item">سنوات</a></li>
                                                    <li><a href="" class="menu-item">مانده مرخصی</a></li>
                                                    <li><a href="" class="menu-item">فیش حقوقی / معوقه</a></li>
                                                    <li><a href="" class="menu-item">وام / مساعده</a></li>
                                                </ul>
                                            </li>
                                            <li class="has-sub">
                                                <a class="menu-item">ورود و خروج</a>
                                                <ul class="menu-content">
                                                    <li><a href="" class="menu-item">تقویم کاری</a></li>
                                                    <li><a href="" class="menu-item">زمان های کاری</a></li>
                                                    <li><a href="" class="menu-item">ماشین ساعت زنی</a></li>
                                                </ul>
                                            </li>
                                            <li><a class="menu-item">گزارش گیری</a></li>
                                            <li class="has-sub">
