...
/**
 * SecretariatsSearchVML represents the model behind the search form of `app\modules\correspondence\models\DAL\Secretariats`.
 */
class SecretariatsSearchVML extends Secretariats
{
    /**
     * {@inheritdoc}
     */
