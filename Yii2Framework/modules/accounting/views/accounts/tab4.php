                        ...
                        action: function (data) {
                            ...
                            if (confirm('" . Yii::t('app', 'Are you sure you want to delete this item?') . "')) {
                                ajaxget('" . Url::to(['/accounting/accounting-costs/delete', 'id' => '000']) . "'.replace('000', obj.id), {}, function (result) {
                                    ...
                                    if (isValid) {
                                        $('#jstreeCost1').jstree('delete_node', obj.id);
                                    }
                                });
                            }
                        }
...
?>
<p>
    <?= Html::a(Yii::t('app', 'مرکز جدید'), ['/accounting/accounting-costs/create'], ['class' => 'btn btn-sm btn-success createCost1']) ?>
</p>
<div id="jstreeCost1"></div>