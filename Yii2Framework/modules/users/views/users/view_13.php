...
/* @var $searchModel_2 app\modules\users\models\VML\UsersDescriptionsSearchModel */
/* @var $dataProvider_2 yii\data\ActiveDataProvider */
?>
<p>
    <span>توضیحات محرمانه</span><br/><br/>
    <?= Html::a(Yii::t('app', 'Create'), ['/users/users-descriptions/create', 'type_id' => 2, 'user_id' => $model->id], ['class' => 'btn btn-sm btn-success mb-1']) ?>
</p>
<?php
Pjax::begin();
...
<hr/>
<p>
    <span>توضیحات خیلی محرمانه</span><br/><br/>
    <?= Html::a(Yii::t('app', 'Create'), ['/users/users-descriptions/create', 'type_id' => 3, 'user_id' => $model->id], ['class' => 'btn btn-sm btn-success mb-1']) ?>
</p>
<?php
Pjax::begin();
echo GridView::widget([
    'dataProvider' => $dataProvider_2,
    'filterModel'  => $searchModel_2,
    'columns'      => [
        ['class' => app\config\widgets\SerialColumn::class],
        'descriptions:raw',
        [
